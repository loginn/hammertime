...
func compute_dps() -> float:
	...
	print("Base crit chance: ", current_crit_chance, "% Base crit damage: ", current_crit_damage, "%")
	
	for affix: Affix in affixes:
		print("Processing affix: ", affix.affix_name, " Value: ", affix.value, " Tags: ", affix.tags)
		# compute base damage
		...
		if Tag.PHYSICAL in affix.tags and Tag.PERCENTAGE in affix.tags:
			...
			new_dps *= multiplier
			print("Applied physical % damage: ", affix.value, "% Multiplier: ", multiplier, " New DPS: ", new_dps)
		# compute attack speed
		if Tag.SPEED in affix.tags:
			var speed_multiplier = (1.0 + affix.value / 100.0)
			new_spd *= speed_multiplier
			print("Applied speed: ", affix.value, "% Speed multiplier: ", speed_multiplier, " New speed: ", new_spd)
		...
		if Tag.CRITICAL in affix.tags and "Chance" in affix.affix_name:
			...
			print("Added crit chance: ", affix.value, "% New crit chance: ", current_crit_chance, "%")
		...
		if Tag.CRITICAL in affix.tags and "Damage" in affix.affix_name:
			...
			print("Added crit damage: ", affix.value, "% New crit damage: ", current_crit_damage, "%")
	...
	print("Final DPS (with crit): ", new_dps, " Crit chance: ", current_crit_chance, "% Crit damage: ", current_crit_damage, "%")
	return new_dps
