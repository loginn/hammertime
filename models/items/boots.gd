class_name Boots extends Item

var computed_armor: int
var computed_movement_speed: int
...
func update_value() -> void:
	...
	# Movement speed (no percentage modifier currently)
	self.computed_movement_speed = (
